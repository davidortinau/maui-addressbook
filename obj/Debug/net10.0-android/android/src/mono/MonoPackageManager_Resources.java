...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AddressBookPlus.dll" comes first in this list. */
		"AddressBookPlus.dll",
		...
		"MauiBootstrapTheme.dll",
		"MauiDevFlow.Agent.dll",
		"MauiDevFlow.Agent.Core.dll",
		"MauiDevFlow.Logging.dll",
		"SQLite-net.dll",
